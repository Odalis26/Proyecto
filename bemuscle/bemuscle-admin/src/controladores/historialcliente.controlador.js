...
historialclientectl.editar = async (req, res) => {
    ...
    await orm.historialCliente.findOne({ where: { historial_cliente_id: id } })
    .then(actualizarhistorialCliente => {
        actualizarhistorialCliente.update(nuevoHistorialCliente)
